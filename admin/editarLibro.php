        ...
        <div class="bg-dark" id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <h3 class="fs-4 mb-3">Listado
                    ...
                    <form action="editandolibro.php" method="POST">
                        <table class="table bg-white rounded shadow-sm table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><a href="nuevolibro.php" target="_self" class="fas fa-plus-circle add-text add-bg border rounded-full p-2" style="margin-left: 65px"></a></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th scope="row"><input class="form-control me-2" type="number" name="id" value="<?php echo $fila['id']; ?>" readonly /></th>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Nro" onkeypress="return solonumeros(event)" onpaste="return false" value="<?php echo $fila['Nro']; ?>" /></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Autor" onkeypress="return sololetras(event)" onpaste="return false" value="<?php echo $fila['Autor']; ?>" /></td>
                                    ...
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="NroED" value="<?php echo $fila['NroED']; ?>" /></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Editorial" onkeypress="return sololetras(event)" onpaste="return false" value="<?php echo $fila['Editorial']; ?>" /></td>
                                    <td class="acciones">
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="AnoEd" onkeypress="return solonumeros(event)" onpaste="return false" value="<?php echo $fila['AnoEd']; ?>" /></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Origen" onkeypress="return sololetras(event)" onpaste="return false" value="<?php echo $fila['Origen']; ?>" /></td>
