...
FROM juegos WHERE juegos.id=$id";
                        ...
                        <table class="table bg-white rounded shadow-sm table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td scope="row"><?php echo$fila['FechIng'];?> </td>
                                    <td scope="row"><?php echo$fila['Observaciones'];?> </td>
                                    <td class="acciones">
                                    <?php echo "<a href='#' onclick='Eliminar({$fila['id']})'"?>
                                    <i class="far fa-trash-alt trash-text border rounded-full trash-bg p-2" title='Eliminar juego'></i></a>&nbsp&nbsp

                                    <a href="editarJuego.php?id=<?php echo $fila['id']; ?>">
                                    <i class="far fa-edit edit-text border rounded-full edit-bg p-2" title='Editar juego' ></i></a>&nbsp&nbsp

                                    <a href="verJuego.php?id=<?php echo $fila['id']; ?>">
                                        <i class="fa fa-eye primary-text border rounded-full secondary-bg p-2" title='Ver juego' ></i></a>&nbsp&nbsp
                                    </td>
                            <?php
                            };
                            }
