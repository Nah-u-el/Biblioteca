...
$sql_regitro = mysqli_query($conex, "SELECT COUNT(*) as total_registro FROM multimedia WHERE id");
...
$sql="SELECT multimedia.id, multimedia.Nro, multimedia.Titulo, multimedia.Responsable, multimedia.MatCompl, multimedia.Idioma, multimedia.AnoEd, multimedia.Soporte
FROM multimedia LIMIT $desde, $por_pagina";
