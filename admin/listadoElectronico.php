...
$sql_regitro = mysqli_query($conex, "SELECT COUNT(*) as total_registro FROM electronicos WHERE id");
...
FROM electronicos LIMIT $desde, $por_pagina";
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <a href="verElectronico.php?id=<?php echo $fila['id']; ?>">
                                        <i class="fa fa-eye primary-text border rounded-full secondary-bg p-2" title='Ver electronico' ></i></a>&nbsp&nbsp
                                    </td>
                            <?php
                            };
                            }
