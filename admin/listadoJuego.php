...
$sql_regitro = mysqli_query($conex, "SELECT COUNT(*) as total_registro FROM juegos WHERE id");
...
$sql="SELECT juegos.id, juegos.Nro, juegos.Nombre, juegos.Marca
FROM juegos LIMIT $desde, $por_pagina";
...
<div class="d-flex" id="wrapper">
                        ...
                        <table class="table bg-white rounded shadow-sm table-hover" >
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <i class="far fa-trash-alt trash-text border rounded-full trash-bg p-2" title='Eliminar juegos'></i></a>&nbsp&nbsp

                                    <a href="editarJuego.php?id=<?php echo $fila['id']; ?>">
                                    <i class="far fa-edit edit-text border rounded-full edit-bg p-2" title='Editar juegos' ></i></a>&nbsp&nbsp
    ...
    if (confirm ("¿Esta seguro que quiere eliminar este juegos?")){
      document.location.href="eliminarJuego.php?id="+val;
