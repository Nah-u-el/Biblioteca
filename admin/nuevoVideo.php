                ...
                <h3 class="fs-4 mb-3">Listado
                    ...
                    <form action="guardarVideo.php" method="POST">
                        <table class="table bg-white rounded shadow-sm table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Nro" placeholder="Ingrese Nro" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Titulo" placeholder="Ingrese Titulo" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Responsable" placeholder="Ingrese Responsable" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Coleccion" placeholder="Ingrese Coleccion" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="time"  name="Duracion" placeholder="Ingrese Duracion" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Color" placeholder="Ingrese Color" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="MatCompl" placeholder="Ingrese Material Complementario" required/></td>
                                    <td class="acciones">
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Idioma" placeholder="Ingrese Idioma" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return solonumeros(event)" onpaste="return false" name="AnoEd" placeholder="Ingrese Año de Editorial" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Soporte" placeholder="Ingrese Formato"  required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Origen" placeholder="Ingrese Origen" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="date" name="FechaIng" placeholder="Ingrese Fecha Ingreso" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Procedencia" placeholder="Ingrese Procedencia" required/></td>
