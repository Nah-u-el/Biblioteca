        ...
        <div class="bg-dark" id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <h3 class="fs-4 mb-3">Listado
                    <a href="listadoJuego.php" class="btn btn-info btn-md my-2 my-sm-0 ml-3 derecha">Volver</a> 
                </h3>                   
                    <div class="col" id="ancho">
                    <form action="editandoJuego.php" method="POST">
                        <table class="table bg-white rounded shadow-sm table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">FechIng</th>
                                    <th scope="col">Observaciones</th>
                                    <th scope="col"><a href="nuevoJuego.php" target="_self" class="fas fa-plus-circle add-text add-bg border rounded-full p-2" style="margin-left: 65px"></a></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Nombre" onkeypress="return sololetras(event)" onpaste="return false" value="<?php echo $fila['Nombre']; ?>" /></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Marca" onkeypress=" return sololetras(event)" onpaste="return false" value="<?php echo $fila['Marca']; ?>" /></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Edad" onkeypress="return solonumeros(event)" onpaste="return false" value="<?php echo $fila['Edad']; ?>" /></td>
                                    <td scope="row"><input class="form-control me-2" type="date" name="FechIng" value="<?php echo $fila['FechIng']; ?>" /></td>
