...
$sql="SELECT multimedia.id, multimedia.Nro, multimedia.Soporte, multimedia.Titulo, multimedia.Responsable, multimedia.Duracion, multimedia.Color, multimedia.MatCompl, multimedia.Idioma, multimedia.AnoEd, multimedia.Origen
FROM multimedia WHERE multimedia.Titulo LIKE'%$Titulo%'";
...
<div class="d-flex" id="wrapper">
                        ...
                        <table class="table bg-white rounded shadow-sm table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td scope="row"><?php echo$fila['Responsable'];?> </td>
                                    <td scope="row"><?php echo$fila['MatCompl'];?> </td>
                                    <td scope="row"><?php echo$fila['Idioma'];?> </td>
                                    <td scope="row"><?php echo$fila['AnoEd'];?> </td>
                                    <td scope="row"><?php echo$fila['Soporte'];?> </td>
                                    <td class="acciones">
                                    <?php echo "<a href='#' onclick='Eliminar({$fila['id']})'"?>
                                    <i class="far fa-trash-alt trash-text border rounded-full trash-bg p-2" title='Eliminar Video'></i></a>&nbsp&nbsp

                                    <a href="editarVideo.php?id=<?php echo $fila['id']; ?>">
                                    <i class="far fa-edit edit-text border rounded-full edit-bg p-2" title='Editar Video'></i></a>&nbsp&nbsp

                                    <a href="verVideo.php?id=<?php echo $fila['id']; ?>">
                                        <i class="fa fa-eye primary-text border rounded-full secondary-bg p-2" title='Ver Video' ></i></a>&nbsp&nbsp
                                    </td>
                                    <?php
                            };
                            }
    ...
    if (confirm ("¿Esta seguro que quiere eliminar este video?")){
      document.location.href="eliminarVideo.php?id="+val;
