        ...
        <div class="bg-dark" id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <h3 class="fs-4 mb-3">Listado
                    ...
                    <form action="guardarJuego.php" method="POST">
                        <table class="table bg-white rounded shadow-sm table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Nro" placeholder="Ingrese Numero" required/></td>
                                    ...
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Marca" placeholder="Ingrese Marca" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return solonumeros(event)" onpaste="return false" name="Edad" placeholder="Ingrese Edad" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="date" name="FechIng" placeholder="Ingrese Fecha Ingreso" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Observaciones" placeholder="Ingrese Observacion" required/></td>
                                    <td class="acciones">
