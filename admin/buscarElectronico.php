...
$sql="SELECT electronicos.id,  electronicos.Nombre, electronicos.Cantidades, electronicos.Observaciones
FROM electronicos WHERE electronicos.Nombre LIKE'%$Nombre%'";
...
<div class="d-flex" id="wrapper">
                        ...
                        <table class="table bg-white rounded shadow-sm table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <i class="far fa-trash-alt trash-text border rounded-full trash-bg p-2" title='Eliminar electronicos'></i></a>&nbsp&nbsp

                                    <a href="editarElectronico.php?id=<?php echo $fila['id']; ?>">
                                    <i class="far fa-edit edit-text border rounded-full edit-bg p-2" title='Editar electronicos' ></i></a>&nbsp&nbsp

                                    <a href="verElectronico.php?id=<?php echo $fila['id']; ?>">
                                        <i class="fa fa-eye primary-text border rounded-full secondary-bg p-2" title='Ver electronicos' ></i></a>&nbsp&nbsp
                                    </td>
                                    <?php
                            };
                            }
    ...
    if (confirm ("¿Esta seguro que quiere eliminar este electronicos?")){
