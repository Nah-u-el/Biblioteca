        ...
        <div class="bg-dark" id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <h3 class="fs-4 mb-3">Listado
                    ...
                    <form action="editandoElectronico.php" method="POST">
                        <table class="table bg-white rounded shadow-sm table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td scope="row"><input class="form-control me-2" maxlength="50" minlength="3" type="varchar" name="Nombre" onkeypress="return sololetras(event)" onpaste="return false" value="<?php echo $fila['Nombre']; ?>" /></td>
                                    <td scope="row"><input class="form-control me-2" maxlength="5" type="varchar" name="Cantidades" onkeypress="return solonumeros(event)" onpaste="return false" value="<?php echo $fila['Cantidades']; ?>" /></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" name="Observaciones" value="<?php echo $fila['Observaciones']; ?>" /></td>
                                    <td scope="row"><input class="form-control me-2" type="date" name="fecha_ingreso" value="<?php echo $fila['fecha_ingreso']; ?>" /></td>
                                    <td class="acciones">
