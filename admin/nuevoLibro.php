    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="listadolibro.php" class="list-group-item list-group-item-action bg-transparent second-text active">
        ...
        <div class="bg-dark" id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 primary-text">Libreria</h2>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <form name="form1" action="buscarlibro.php" method="post">
            ...
            <div class="container-fluid px-4">
                ...
                <h3 class="fs-4 mb-3">Listado
                    <a href="listadoLibro.php" class="btn btn-info btn-md my-2 my-sm-0 ml-3 derecha">Volver</a> 
                </h3>                   
                    ...
                    <form action="guardarlibro.php" method="POST">
                        <table class="table bg-white rounded shadow-sm table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return solonumeros(event)" onpaste="return false" name="Nro" placeholder="Ingrese Numero" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Autor" placeholder="Ingrese Autor" required/></td>
                                    ...
                                    <td scope="row"><input class="form-control me-2" type="varchar"  name="NroED" placeholder="Ingrese Numero Editorial" required/></td>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Editorial" placeholder="Ingrese Editorial" required/></td>
                                    <td class="acciones">
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return solonumeros(event)" onpaste="return false" name="AnoEd" placeholder="Ingrese Año Editorial" required/></td>
                                    ...
                                    <td scope="row"><input class="form-control me-2" type="varchar" onkeypress="return sololetras(event)" onpaste="return false" name="Observaciones" placeholder="Ingrese Observaciones"/></td>
                                </tr>
                            </tbody>
                        </table>
                    </form>
