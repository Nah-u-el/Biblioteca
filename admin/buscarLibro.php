...
$sql="SELECT libros.id, libros.Titulo, libros.Autor, libros.NroED, libros.Editorial, libros.AnoEd, libros.Origen
FROM libros WHERE libros.Titulo LIKE'%$Titulo%'";
                        ...
                        <table class="table bg-white rounded shadow-sm table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td scope="row"><?php echo$fila['NroED'];?> </td>
                                    <td scope="row"><?php echo$fila['Editorial'];?> </td>
                                    <td scope="row"><?php echo$fila['AnoEd'];?> </td>
                                    <td scope="row"><?php echo$fila['Origen'];?> </td>
                                    <td class="acciones">
